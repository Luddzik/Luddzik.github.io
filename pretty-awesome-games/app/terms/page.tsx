      ...
      <main className={styles.terms} id="top">
        <div className={styles.container}>
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old (or the minimum age in your jurisdiction) to use our Service. By using
            ...
            <p>
              ...
              regulations in your place of residence. If any applicable law prohibits your participation, you must cease
              using the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Use cheats, exploits, automation software, bots, or any unauthorized third-party software designed to
                modify or interfere with the Service.
              </li>
              ...
              <li>
                Circumvent or attempt to circumvent any security feature, access control measure, or other technological
                protection used in the Service.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                Post or transmit any content that is unlawful, threatening, harassing, defamatory, obscene, or otherwise
                objectionable.
              </li>
              <li>Impersonate any person or entity or falsely claim an affiliation with any person or entity.</li>
              <li>
                Engage in any activity that disrupts or interferes with the Service or the servers/networks connected to
                the Service.
              </li>
          ...
          <section>
            ...
            <ul>
              <li>
                All purchases are final and non-refundable unless otherwise specified by applicable law or our written
                refund policy.
              </li>
              <li>You agree to pay all fees and applicable taxes incurred by you or anyone using your account.</li>
              <li>
                We reserve the right to change our pricing and refund policy at any time. Any changes will be posted as
          ...
          <section>
            ...
            <p>
              You may be required to create an account to access certain features of the Service. You must provide
              accurate and complete information during the registration process and keep your account information
          ...
          <section>
            ...
            <p>
              Upon termination, your right to use the Service will immediately cease. You acknowledge that we are not
              required to provide refunds or compensation for any unused Virtual Items or other purchases.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We do not guarantee that the Service will be uninterrupted, error-free, secure, or free of viruses or
              other harmful components. Your use of the Service is at your own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                ...
                mandates certain consumer or data protection measures, we will comply with the applicable provisions to
                the extent required by law.
              </li>
              <li>
                In the event any provision of these Terms conflicts with mandatory local laws, those local laws will
                prevail solely to the extent of the conflict, and all other provisions of these Terms will remain in
                effect.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              We may revise these Terms from time to time by posting an updated version on our website or within the
              Service. If we make any material changes, we will notify you by posting a notice or by other means
              required by law. Your continued use of the Service after the effective date of any updated Terms indicates
          ...
          <section>
            ...
            <p>
              Our failure to enforce any right or provision in these Terms shall not constitute a waiver of such right
              or provision.
            </p>
            <h3>15.3 Assignment</h3>
            <p>
              You may not assign or transfer these Terms or your rights or obligations hereunder without our prior
